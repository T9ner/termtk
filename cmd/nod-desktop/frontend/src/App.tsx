...
function App() {
  ...
  useEffect(() => {
    ...
    const cleanups = [
      ...
      // D2: Native OS notifications for incoming messages
      EventsOn('show_notification', (data: { title: string; body: string }) => {
        if (Notification.permission === 'granted') {
          new Notification(data.title, { body: data.body, icon: '/wails.png' });
                ...
                <div key={msg.id} className={`message-row ${msg.isMe ? 'me' : 'them'}`}>
                  ...
                  >
                    ...
                    <div className="message-time">
                      ...
                      {msg.encrypted && <span className="message-encrypted" title="End-to-end encrypted"><svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg></span>}
                    </div>
